        ...
        <form class="updateItem" action="" method="POST" id="updateItem">
            <div class="form-row">
                <div class="col-md-2 mb-3">
                    ...
                    <input class="form-control" id="uniqueItemCode" name="uniqueItemCode" type="text" placeholder="Product Code" style="text-transform:uppercase" value="<?php echo isset($uniqueItemCode)? $uniqueItemCode : ''; ?>" required readonly />
                </div>
            ...
            <div class="form-row">
                <div class="col-md-6 mb-3">
                    <label for="itemCompanyCode">Product's company</label>
            ...
            <button type="submit" class="btn btn-warning mr-2 my-1" type="button">Update Product</button>
        </form>
    </div>
</div>
