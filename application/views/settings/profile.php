<div class="container">
    <div class="main-body">
            <?php
                ...
                $first_name = isset($data[0]->first_name) ? $data[0]->first_name : "";
                $name = $first_name . " ". (isset($data[0]->last_name) ? $data[0]->last_name : "");
                $email = isset($data[0]->email) ? $data[0]->email : "";
                $mobile_number = isset($data[0]->mobile_number) ? $data[0]->mobile_number : "";
                $username = isset($data[0]->username) ? $data[0]->username : "";
                $role = isset($data[0]->role) ? $data[0]->role : "";

                $address = isset($data[0]->address) ? $data[0]->address : "";
                $area = isset($data[0]->area) ? $data[0]->area : "";
                $city = isset($data[0]->city) ? $data[0]->city : "";
                $district = isset($data[0]->district) ? $data[0]->district : "";
                $state = isset($data[0]->state) ? $data[0]->state : "";
                $pin_code = isset($data[0]->pin_code) ? $data[0]->pin_code : "";
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <p class="text-muted font-size-sm"><?php echo $full_address; ?></p>
