        ...
        <form class="purchaseinvoice" action="" method="POST" id="purchaseinvoice">
            ...
            <div class="form-row">
                <div class="col-md-3 mb-3">
                    ...
                    <input class="form-control" id="panno" name="panno" type="text" placeholder="Payment mode" value="<?php echo isset($firmName)? $firmName : ''; ?>" required/>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input class="form-control" id="panno" name="panno" type="text" placeholder="Vehicle No." value="<?php echo isset($firmName)? $firmName : ''; ?>" required/>
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-primary mr-2 my-1" type="button">Create invoice</button>
        </form>
    </div>
    <script>
