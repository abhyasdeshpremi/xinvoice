                        ...
                        <form class="purchaseinvoice" id="purchaseinvoice">
                           ...
                           <hr>
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="userStatus">From Invoice Client Name</label>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" target="_blank" href="<?php echo base_url('/createpurchaseinvoicepdf'."/".$invoiceid)."/portrait/1"; ?>" download>Download Invoice</a>
                                    </div>
                                </div>
                            </div>
                        </div>
