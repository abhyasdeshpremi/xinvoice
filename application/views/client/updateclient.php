    ...
    <div class="col-lg-12">
        ...
        <?php 
            foreach($data as $value){ 
                ...
                $clientMobile = $value->mobile_no;
                $clientgst = $value->gst_no;
                $clientPan = $value->pan_no;
                $clientaadhar = $value->aadhar_no;
                $clientfssai = $value->fssai_no;

                $clientAddress = $value->address;
                $clientArea = $value->area;
                $clientCity = $value->city;

                $clientdistrict = $value->district;
                $clientState = $value->state;
                $clientZip = $value->pin_code;
            }
        ?>
        <form class="createClient" action="" method="POST" id="createClient">
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input class="form-control" id="uniqueCode" name="uniqueCode" type="text" placeholder="Client Code" style="text-transform:uppercase" value="<?php echo isset($uniqueCode)? $uniqueCode : ''; ?>" required readonly/>
                </div>
