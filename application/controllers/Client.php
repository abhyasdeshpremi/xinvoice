...
class Client extends CI_Controller {
    ...
    public function clientdetails(){
        ...
        $data["base_url"] = base_url("clientdetails");

        $config = array();
        $config["base_url"] = base_url("clientdetails".$searchurl."".$globalsearchtext);
        $config["total_rows"] = $this->Client_model->get_count(urldecode($globalsearchtext));
        ...
        $firm_result = $this->Client_model->client_list($config["per_page"], $page, urldecode($globalsearchtext));
